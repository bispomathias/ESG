...
#define BLYNK_TEMPLATE_ID "TMPL23B1YilgV"
#define BLYNK_TEMPLATE_NAME "Estação Meteorológica IoT"
#define BLYNK_AUTH_TOKEN "VUlrZQNYN50aHIv6KqVCkTapIHsLRBrN"
...
char ssid[] = "CEET_Online";    // Rede WiFi
char pass[] = "vasco@2023";     // Senha da rede WiFi
...
void Pressao()
{
    ...
    if (status != 0)
    {                                                 // Se status for diferente de zero (sem erro de leitura)
